...
describe("converters functions", () => {
  ...
  it("includes() should be able to convert to the correct pattern.", () => {
    const result = includes(["apple", "orange"]);
    RESULT_LIST.push(result);
    expect(result).toBe("includes:apple,orange");
  });
  ...
  it("notIncludes() should be able to convert to the correct pattern.", () => {
    const result = notIncludes(["apple", "orange"]);
    RESULT_LIST.push(result);
    expect(result).toBe("not_includes:apple,orange");
  });
