...
export const eu: ILocale = {
  ...
  values: {
    ...
    includes: "Hautatutako eremua ez da baliozkoa.",
    ...
    not_includes: "Hautatutako eremua ez da baliozkoa.",
...
export const fa: ILocale = {
  ...
  values: {
    ...
    includes: "انتخاب شده برای فیلد معتبر نیست.",
    ...
    not_includes: "انتخاب شده برای فیلد معتبر نیست.",
...
export const fi: ILocale = {
  ...
  values: {
    ...
    includes: "Valittu kenttä ei ole kelvollinen.",
    ...
    not_includes: "Valittu kenttä ei ole kelvollinen.",
...
export const fr: ILocale = {
  ...
  values: {
    ...
    includes: "La valeur sélectionnée du champ n'est pas valide.",
    ...
    not_includes: "La valeur sélectionnée du champ n'est pas valide.",
...
export const hr: ILocale = {
  ...
  values: {
    ...
    includes: "Odabrano polje nije valjano.",
    integer: "Polje mora biti cijeli broj.",
    hex: "Polje mora imati heksadecimalni format.",
    min: "Polje mora biti barem {0}.",
    max: "Polje ne smije biti veće od {0}.",
    not_includes: "Odabrano polje nije valjano.",
    numeric: "Polje mora biti broj.",
    required: "Polje je obavezno.",
    size: "Veličina polja mora biti {0}.",
...
export const hu: ILocale = {
  ...
  values: {
    ...
    includes: "A kiválasztott érték érvénytelen.",
    ...
    not_includes: "A kiválasztott érték érvénytelen.",
...
export const id: ILocale = {
  ...
  values: {
    ...
    includes: "Pilihan bidang ini tidak valid.",
    ...
    not_includes: "Pilihan bidang ini tidak valid.",
...
export const it: ILocale = {
  ...
  values: {
    ...
    includes: "Il campo selezionato non è valido.",
    ...
    not_includes: "Il campo selezionato non è valido.",
...
export const ka: ILocale = {
  ...
  values: {
    ...
    includes: "არჩეული ველი არასწორია.",
    ...
    not_includes: "არჩეული ველი არასწორია.",
...
export const li: ILocale = {
  ...
  values: {
    ...
    includes: "Pasirinktas laukas yra netinkamas.",
    ...
    not_includes: "Pasirinktas laukas yra netinkamas.",
...
export const lt: ILocale = {
  ...
  values: {
    ...
    digits_between: "Šis laukas turi būti tarp {0} ir {1} skaitmenų.",
    includes: "Pasirinktas laukas yra neteisingas.",
    integer: "Šis laukas turi būti sveikasis skaičius.",
    hex: "Šis laukas turi turėti heksadecimale formatą",
    min: "Šis laukas turi būti bent {0}.",
    max: "Šis laukas negali būti didesnis nei {0}.",
    not_includes: "Pasirinktas laukas yra neteisingas.",
    numeric: "Šis laukas turi būti skaičius.",
    required: "Šis laukas yra privalomas.",
    size: "Šio lauko dydis turi būti {0}.",
...
export const lv: ILocale = {
  ...
  values: {
    ...
    includes: "Atlasītais lauks nav derīgs.",
    ...
    not_includes: "Atlasītais lauks nav derīgs.",
...
export const mk: ILocale = {
  ...
  values: {
    ...
    includes: "Избраното поле не е валидно.",
    ...
    not_includes: "Избраното поле не е валидно.",
...
export const mn: ILocale = {
  ...
  values: {
    ...
    includes: "Сонгосон талбайн утга буруу байна.",
    ...
    not_includes: "Сонгосон талбайн утга буруу байна.",
...
export const ms: ILocale = {
  ...
  values: {
    ...
    includes: "Pilihan medan ini tidak sah.",
    ...
    not_includes: "Pilihan medan ini tidak sah.",
...
export const nl: ILocale = {
  ...
  values: {
    ...
    includes: "De geselecteerde waarde is ongeldig.",
    ...
    not_includes: "De geselecteerde waarde is ongeldig.",
...
export const no: ILocale = {
  ...
  values: {
    ...
    includes: "Den valgte verdien er ugyldig.",
    ...
    not_includes: "Den valgte verdien er ugyldig.",
...
export const pl: ILocale = {
  ...
  values: {
    ...
    includes: "Wybrana wartość pola jest nieprawidłowa.",
    ...
    not_includes: "Wybrana wartość pola jest nieprawidłowa.",
...
export const ro: ILocale = {
  ...
  values: {
    ...
    includes: "Câmpul selectat nu este valid.",
    ...
    not_includes: "Câmpul selectat nu este valid.",
...
export const ru: ILocale = {
  ...
  values: {
    ...
    includes: "Выбранное поле недопустимо.",
    ...
    not_includes: "Выбранное поле недопустимо.",
...
export const se: ILocale = {
  ...
  values: {
    ...
    includes: "Det valda fältet är ogiltigt.",
    ...
    not_includes: "Det valda fältet är ogiltigt.",
...
export const sl: ILocale = {
  ...
  values: {
    ...
    includes: "Izbrano polje ni veljavno.",
    ...
    not_includes: "Izbrano polje ni veljavno.",
...
export const sq: ILocale = {
  ...
  values: {
    ...
    includes: "Fusha e zgjedhur është e pavlefshme.",
    ...
    not_includes: "Fusha e zgjedhur është e pavlefshme.",
...
export const tr: ILocale = {
  ...
  values: {
    ...
    includes: "Seçilen alan geçersiz.",
    ...
    not_includes: "Seçilen alan geçersiz.",
...
export const uk: ILocale = {
  ...
  values: {
    ...
    includes: "Вибране поле недійсне.",
    ...
    not_includes: "Вибране поле недійсне.",
...
export const vi: ILocale = {
  ...
  values: {
    ...
    includes: "Giá trị đã chọn không hợp lệ.",
    ...
    not_includes: "Giá trị đã chọn không hợp lệ.",
